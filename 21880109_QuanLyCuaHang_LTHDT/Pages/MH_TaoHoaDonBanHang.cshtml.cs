...
{
    public class MH_TaoHoaDonBanHangModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            HoaDonBan.MaHoaDon = MaHoaDon;
            HoaDonBan.NgayTaoHoaDon = NgayTao;
            HoaDonBan.ChiTiet = a;
            bool kq = xuLyHoaDon.TaoHoaDonBanHang(HoaDonBan);
            Chuoi = $"Ket qua la {kq}";
        }
        public MH_TaoHoaDonBanHangModel()
        {
